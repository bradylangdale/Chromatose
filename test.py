...
from viewer import CustomViewer

pyglet.options['shadow_window'] = False
import numpy as np
import trimesh

from pyrender import PerspectiveCamera, DirectionalLight, SpotLight, PointLight, Mesh, Node, Scene
...
rocket_trimesh = trimesh.load('EstesV2.obj', force='mesh')
rocket_mesh = Mesh.from_trimesh(rocket_trimesh)
...
scene = Scene(ambient_light=np.array([0.02, 0.02, 0.02, 0.5]))
...
rocket_node = scene.add(rocket_mesh)

# ==============================================================================
# Using the viewer with a pre-specified camera
# ==============================================================================
cam_node = scene.add(cam)
v = CustomViewer(scene, central_node=drill_node)
