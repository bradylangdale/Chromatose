"""CameraController class for 3D manipulation of viewpoints.
"""
import numpy as np
...
class CameraController(object):
    """A CameraController class for creating camera transforms from mouse movements.
    """
    STATE_ROTATE = 0
    STATE_PAN = 1
    STATE_ROLL = 2
    ...
    def __init__(self, pose, size, scale,
        ...
        """Initialize a CameraController with an initial camera-to-world pose
        and the given parameters.

        Parameters
        ----------
        pose : [4,4]
            An initial camera-to-world pose for the CameraController.
        ...
        target : (3,) float
            ...
            The CameraController will revolve around this point.
        """
        ...
        self._state = CameraController.STATE_ROTATE
    ...
    def set_state(self, state):
        """Set the state of the CameraController in order to change the effect of
        dragging motions.

        Parameters
        ----------
        state : int
            One of CameraController.STATE_ROTATE, CameraController.STATE_PAN,
            CameraController.STATE_ROLL, and CameraController.STATE_ZOOM.
        """
        self._state = state
    ...
    def drag(self, point):
        ...
        point : (2,) int
            ...
            This will compute a movement for the CameraController with the relative
        ...
        if self._state == CameraController.STATE_ROTATE:
            x_angle = -dx / mindim
        ...
        elif self._state == CameraController.STATE_ROLL:
        ...
        elif self._state == CameraController.STATE_PAN:
        ...
        elif self._state == CameraController.STATE_ZOOM:
    ...
    def rotate(self, azimuth, axis=None):
        """Rotate the CameraController about the "Up" axis by azimuth radians.
